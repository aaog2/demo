    ...
    <div class="page">
      <div class="containers py-4">
        ...
        <div class="btn-containers pt-4">
          <button class="mx-4 shadow-sm clearbutton" @click="clearData">
          ...
          >
            <tr>
              ...
              <td v-if="employees.contract_upload && !edit">
                <button
                  v-if="!employees.contract_upload.pdf"
                  class="btn btn-primary"
                  @click="showFile(employees.contract_upload.id)"
                >
                  Upload File
                </button>
                <button
                  v-else-if="employees.contract_upload.pdf"
                  class="btn btn-success"
                  @click.left="getfile(employees.contract_upload.pdf)"
              ...
              <td v-else-if="employees.contract_upload && edit">
                <button
                  ...
                  @click.leftt="showFile(employees.contract_upload.id)"
                  @click.right="edit = !edit"
                >
                  Update File
                </button>
              ...
              <td>
                <font-awesome-icon
                  ...
                  @click="showmodal(employees.user_id)"
                />
              </td>
              <td v-if="employees.contract_upload">
                <button
                  class="btn btn-outline-danger"
                  @click="deleteContract(employees.contract_upload.id)"
                >
                  <font-awesome-icon icon="fa-solid fa-trash" />
                </button>
              </td>
