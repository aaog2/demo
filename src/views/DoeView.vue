    ...
    <div v-if="errorMessage && message" class="errorMessage">
      <div class="error-message">
        <div class="modalss">
          ...
          <button class="btn btn-danger" @click="closemessage">
          ...
          <form class="row col-12">
            ...
            <div class="form-group col-8 col-lg-5 col-xl-3">
              ...
              <select class="form-select" id="factory" v-model="factoryName">
                <option
                  value="SYARIKAT SIN KWANG PLASTIC INDUSTRIES SDN BHD"
                  selected
                >
                  SYARIKAT SIN KWANG PLASTIC INDUSTRIES SDN BHD
                </option>
                <option value="Thai Union Group Public Co.,Ltd">
                  Thai Union Group Public Co.,Ltd
                </option>
                <option value="Thai Union Manufacturing Co.,Ltd">
                  Thai Union Manufacturing Co.,Ltd
                </option>
                <option value="I Tail Corporation Public Co.,Ltd">
                  I Tail Corporation Public Co.,Ltd
                </option>
                <option value="Lucky Union Food Co.,Ltd ">
                  Lucky Union Food Co.,Ltd
                </option>
                <option value="Okeanos Food Co.,Ltd">
                  Okeanos Food Co.,Ltd
                </option>
                <option value="Thai Union Feedmill Co.,Ltd">
                  Thai Union Feedmill Co.,Ltd
                </option>
                <option value="Pakfood Public Co.,Ltd">
                  Pakfood Public Co.,Ltd
                </option>
                <option value="South East Asia Packaging and Canning Co.,Ltd">
                  South East Asia Packaging and Canning Co.,Ltd
                </option>
              </select>
            </div>
            ...
            <div class="form-group col-4 col-xl-3 mt-4 mt-xl-0">
              ...
              <select
                class="form-select"
                id="category"
                v-model="factoryCategory"
              >
                <option
                  value="ပလတ်စတစ်ဖြင့်ပြုလုပ်သော အီလက်ထရောနစ်ပစ္စည်းများ ထုတ်လုပ်သည့် လုပ်ငန်း"
                >
                  ပလတ်စတစ်ဖြင့်ပြုလုပ်သော အီလက်ထရောနစ်ပစ္စည်းများ ထုတ်လုပ်သည့်
                  လုပ်ငန်း
                </option>
                <option value="ပင်လယ်အစားအစာထုတ်လုပ်ခြင်း လုပ်ငန်း">
                  ပင်လယ်အစားအစာထုတ်လုပ်ခြင်း လုပ်ငန်း
                </option>
              </select>
            </div>
            ...
            <div class="form-group col-4 col-xl-3 mt-4">
              ...
              >
                <input
                  ...
                  checked
                />
                <label class="btn btn-outline-primary" for="familyTreeYes"
                  >Old</label
                >
                ...
                <input
                  ...
                  v-model="newEmployee"
                />
                <label class="btn btn-outline-primary" for="familyTreeNo"
                  >New</label
                >
              </div>
            </div>
            ...
            <div class="btn-containers mt-4">
              <button class="mx-3 shadow-sm clearbutton" @click="clearForm">
                <span class="button-content pe-1">Clear All </span
        ...
        <table class="table table-striped table-hover table-sm">
          ...
          <tbody>
            <tr v-if="reverse" v-for="(doe, index) in does" :key="doe.id">
              ...
              <td>
                {{ doe.salary
                }}<span v-if="doe.factory_country === 'Thai'"> Bath</span
                ><span v-if="doe.factory_country === 'Malaysia'"> Ringgit</span>
              </td>
              <td>{{ doe.is_new_employee === 1 ? "new" : "old" }}</td>
            </tr>
            <tr
              v-if="!reverse"
              v-for="(doe, index) in does.slice().reverse()"
              :key="doe.id"
            >
...
export default {
  ...
  setup() {
    ...
    // Clear Form Data
    let clearForm = () => {
      (doesId.value = ""), (factoryLocation.value = "");
    };
