<template>
  <div class="suveryformContainers">
    ...
    <SurveyFormone
      v-if="firstSurveyState"
      class="zindex"
      @success="showsuccess"
    ></SurveyFormone>
    <SurveyFormtwo
      v-if="secondSurveyState"
      class="zindex"
      @success="showsuccess"
    ></SurveyFormtwo>
    <SurveyFormthree
      v-if="thirdSurveyState"
      class="zindex"
      @success="showsuccess"
    ></SurveyFormthree>
    <SurveyFormfour
      v-if="fourthSurveyState"
      class="zindex"
      @success="showsuccess"
    ></SurveyFormfour>
    <SurveyFormfive
      v-if="fifthSurveyState"
      class="zindex"
      @success="showsuccess"
    ></SurveyFormfive>
    <SurveyFormsix
      v-if="sixthSurveyState"
      class="zindex"
      @success="showsuccess"
    ></SurveyFormsix>
    <SurveyFormseven
      v-if="seventhSurveyState"
      class="zindex"
      @success="showsuccess"
    ></SurveyFormseven>
    <SurveyFormeight
      v-if="eighthSurveyState"
      class="zindex"
      @success="showsuccess"
    ></SurveyFormeight>
  </div>
  ...
  setup() {
    ...
    const surveyData = async () => {
      try {
        ...
        firstSurveyPermission.value =
          res.data.data.employee_info.first_survey_permission;
        secondSurveyPermission.value =
          res.data.data.employee_info.second_survey_permission;
        thirdSurveyPermission.value =
          res.data.data.employee_info.third_survey_permission;
        fourthSurveyPermission.value =
          res.data.data.employee_info.fourth_survey_permission;
        fifthSurveyPermission.value =
          res.data.data.employee_info.fifth_survey_permission;
        sixthSurveyPermission.value =
          res.data.data.employee_info.sixth_survey_permission;
        sevenSurveyPermission.value =
          res.data.data.employee_info.seventh_survey_permission;
        eighthSurveyPermission.value =
          res.data.data.employee_info.eighth_survey_permission;
        ...
        firstSurveyPermission.value !== null &&
        res.data.data.surveyIds.first_survey_id === null
          ? (firstSurveyState.value = true)
          : (firstSurveyState.value = false);
        secondSurveyPermission.value !== null &&
        res.data.data.surveyIds.second_survey_id === null
          ? (secondSurveyState.value = true)
          : (secondSurveyState.value = false);
        thirdSurveyPermission.value !== null &&
        res.data.data.surveyIds.third_survey_id === null
          ? (thirdSurveyState.value = true)
          : (thirdSurveyState.value = false);
        fourthSurveyPermission.value !== null &&
        res.data.data.surveyIds.fourth_survey_id === null
          ? (fourthSurveyState.value = true)
          : (fourthSurveyState.value = false);
        fifthSurveyPermission.value !== null &&
        res.data.data.surveyIds.fifth_survey_id === null
          ? (fifthSurveyState.value = true)
          : (fifthSurveyState.value = false);
        sixthSurveyPermission.value !== null &&
        res.data.data.surveyIds.sixth_survey_id === null
          ? (sixthSurveyState.value = true)
          : (sixthSurveyState.value = false);
        sevenSurveyPermission.value !== null &&
        res.data.data.surveyIds.seventh_survey_id === null
          ? (seventhSurveyState.value = true)
          : (seventhSurveyState.value = false);
        eighthSurveyPermission.value !== null &&
        res.data.data.surveyIds.eighth_survey_id === null
          ? (eighthSurveyState.value = true)
          : (eighthSurveyState.value = false);
        console.log(eighthSurveyState.value);
